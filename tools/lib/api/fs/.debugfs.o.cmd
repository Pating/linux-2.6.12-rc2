fs/debugfs.o: fs/debugfs.c /usr/include/errno.h /usr/include/features.h \
 ...
 /usr/include/linux/kernel.h fs/debugfs.h fs/findfs.h
cmd_fs/debugfs.o := gcc -Wp,-MD,fs/.debugfs.o.d,-MT,fs/debugfs.o -Wbad-function-cast -Wdeclaration-after-statement -Wformat-security -Wformat-y2k -Winit-self -Wmissing-declarations -Wmissing-prototypes -Wnested-externs -Wno-system-headers -Wold-style-definition -Wpacked -Wredundant-decls -Wshadow -Wstrict-aliasing=3 -Wstrict-prototypes -Wswitch-default -Wswitch-enum -Wundef -Wwrite-strings -Wformat  -ggdb3 -Wall -Wextra -std=gnu99 -Werror -O6 -D_FORTIFY_SOURCE=2 -fPIC -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D"BUILD_STR(s)=\#s"   -c -o fs/debugfs.o fs/debugfs.c
